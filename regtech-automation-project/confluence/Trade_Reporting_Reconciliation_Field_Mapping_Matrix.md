...
| EMIR | EMIR UK REFIT | Valuation/Notional | `EMIR3_UK_Refit_Report_Daily.Valuation_amount`, `Price`, `Notional_amount_of_leg_1` | Built in `#all` from `#Valid_Pos`, `#pos_openprice`, `#PricesEOD`, `#EMIR2_Position` | Payload valuation/notional/price | TR valuation and amount response fields | UTI + valuation date | Numeric tolerance classes V1/N1/P1 | T+1 | Warning/Critical | Reg Ops + Finance Control | Procedure-validated | Position/trade branches with GBX/ISO handling |
